...
<html lang="en">
    ...
    <head>
        ...
        <?php echo css_asset('simple-line-icons.min.css') ?>
        <?php echo css_asset('bootstrap.min.css') ?>
        <?php echo css_asset('bootstrap-switch.min.css') ?>
        <!-- END GLOBAL MANDATORY STYLES -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <?php echo css_asset('select2.min.css') ?>
        <?php echo css_asset('select2-bootstrap.min.css') ?>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL STYLES -->
        <?php echo css_asset('components-rounded.min.css') ?>
        <?php echo css_asset('plugins.min.css') ?>
        <?php echo css_asset('login-4.min.css') ?>
...
<![endif]-->
        ...
        <?php echo js_asset('js.cookie.min.js') ?>
        <?php echo js_asset('jquery.slimscroll.min.js') ?>
        <?php echo js_asset('jquery.blockui.min.js') ?>
        <?php echo js_asset('bootstrap-switch.min.js') ?>
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <?php echo js_asset('jquery.validate.min.js') ?>
        <?php echo js_asset('additional-methods.min.js') ?>
        ...
        <?php echo js_asset('login-4.min.js') ?>
